...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'adv_ml.all': {},
            'adv_ml.backdoor': { 'adv_ml.backdoor.BackdoorAttack': ('backdoor.html#backdoorattack', 'adv_ml/backdoor.py'),
                                 'adv_ml.backdoor.BackdoorAttack.validate': ('backdoor.html#backdoorattack.validate', 'adv_ml/backdoor.py'),
                                 ...
                                 'adv_ml.backdoor.BadNetsAttack.validate': ('backdoor.html#badnetsattack.validate', 'adv_ml/backdoor.py'),
                                 ...
                                 'adv_ml.backdoor.DataPoisoningAttack._poison': ( 'backdoor.html#datapoisoningattack._poison',
                                                                                  'adv_ml/backdoor.py'),
                                 'adv_ml.backdoor.DataPoisoningAttack._poison_dl': ( 'backdoor.html#datapoisoningattack._poison_dl',
                                                                                     'adv_ml/backdoor.py'),
                                 'adv_ml.backdoor.DataPoisoningAttack._subset_to_poison': ( 'backdoor.html#datapoisoningattack._subset_to_poison',
                                                                                            'adv_ml/backdoor.py'),
                                 'adv_ml.backdoor.DataPoisoningAttack.poison': ( 'backdoor.html#datapoisoningattack.poison',
                                                                                 'adv_ml/backdoor.py'),
